...
public class News extends Fragment implements PromotionsAdapter.ClickListner{
    ...
    private void adaptersetup(){
        ...
        dref = FirebaseDatabase.getInstance().getReference("News").child("Category").child("Fashion").child("women").child("lingerie").getRef();
        pd.show();

...
public class AutoIndus extends AppCompatActivity {
...
private Promo cat;
   ...
   DatabaseReference dref;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Automobile and Industries");
    ...
    private void initialiseAdapter() {
        ...
        dref = FirebaseDatabase.getInstance().getReference("Categories").child("Auto").getRef();
        pd.show();

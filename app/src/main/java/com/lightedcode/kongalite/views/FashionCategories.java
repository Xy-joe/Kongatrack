...
public class FashionCategories extends AppCompatActivity {
...
public Promo cat;
   ...
   DatabaseReference dref;
    ...
    private void initialiseAdapter() {
        ...
        dref = FirebaseDatabase.getInstance().getReference("News").child("Category").child("Fashion").child("women").child("General").getRef();
        pd.show();

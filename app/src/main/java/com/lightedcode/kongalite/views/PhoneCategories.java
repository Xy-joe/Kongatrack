...
public class PhoneCategories extends AppCompatActivity {
...
private Promo cat;
   ...
   Connectivity connectivity;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Phones and Accessories");
    ...
    private void initialiseAdapter(){
        ...
        dref = FirebaseDatabase.getInstance().getReference("Categories").child("Mobile").getRef();
        pd.show();
